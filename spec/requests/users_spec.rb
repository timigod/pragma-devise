...
RSpec.describe '/users' do
  ...
  describe 'GET /current' do
    subject { -> { get api_v1_user_path(id: 'current') } }
  ...
  describe 'POST /' do
    subject { -> { post api_v1_users_path, body.to_json } }
  ...
  describe 'PATCH /current' do
    subject { -> { patch api_v1_user_path(id: 'current'), body.to_json } }
  ...
  describe 'DELETE /current' do
    subject { -> { delete api_v1_user_path(id: 'current') } }
